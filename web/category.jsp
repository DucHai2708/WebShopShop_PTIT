    ...
    <div class="breadcrumb-section">
        <div class="container-fluid"> <nav aria-label="breadcrumb">
                <ol class="breadcrumb custom-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Áo Thu Đông</a></li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-2 size-column">
                                    ...
                                    <ul class="filter-list">
                                        <li><input type="checkbox" id="size-5xl"> <label for="size-5xl">5XL</label></li>
                                        <li><input type="checkbox" id="size-4xl"> <label for="size-4xl">4XL</label></li>
                                        <li><input type="checkbox" id="size-3xl"> <label for="size-3xl">3XL</label></li>
                                        <li><input type="checkbox" id="size-2xl"> <label for="size-2xl">2XL</label></li>
                                        <li><input type="checkbox" id="size-xl"> <label for="size-xl">XL</label></li>
                                        <li><input type="checkbox" id="size-l"> <label for="size-l">L</label></li>
                                        <li><input type="checkbox" id="size-m"> <label for="size-m">M</label></li>
                                        <li><input type="checkbox" id="size-s"> <label for="size-s">S</label></li>
                                    </ul>
                                </div>

                                <div class="col-xl-6">
                                    <ul class="filter-list">
                                        <li><input type="checkbox" id="price-1"> <label for="price-1">Dưới
                                                200,000</label></li>
                                        <li><input type="checkbox" id="price-2"> <label for="price-2">Từ 200,000 -
                                                500,000</label></li>
                                        <li><input type="checkbox" id="price-3"> <label for="price-3">Từ 500,000 -
                                                1,000,000</label></li>
                                        <li><input type="checkbox" id="price-4"> <label for="price-4">Trên
                                                1,000,000</label></li>
                                    </ul>
                                </div>
