                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3">
                                            ...
                                            <p style="font-size: 14px; margin-bottom: 5px;"><b>Địa chỉ: </b>Số 110 Phố
                                                Nhổn, Phường Tây Tựu,
                                                Quận Bắc Từ Liêm, Tp. Hà Nộ</p>
                                            <p style="font-size: 14px; margin-bottom: 5px;"><b>Mã Số Doanh Nghiệp:
                                                </b>01D-8004624</p>
                                            <p style="font-size: 14px; margin-bottom: 5px;"><b>Email: </b>cntt@atino.vn
                                            </p>
                                        </div>
                                        <div class="col-xl-3">
