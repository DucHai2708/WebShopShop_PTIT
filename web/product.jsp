...
<% Product product = (Product) request.getAttribute("product");
    ...
    String formattedPrice = nf.format((long) product.getPrice());
            ...
            <div class="container-fluid">
                <div class="inner-wrap">
                    ...
                    <div class="account-wrap">
                        <% com.shopshop.model.Users sessionUser = (com.shopshop.model.Users) session.getAttribute("user"); %>
                        <% if (sessionUser != null) {%>
                        <div class="account">
                            <i
                                    ...
                                    <div class="nav-item-has-dropdown">
                                        ...
                                        <div class="nav-dropdown">
                                            <% List<Category> listWinter
                                                        = (List<Category>) request.getAttribute("winter");
                                                if (listWinter != null) {
                                                    for (Category c
                                                            : listWinter) {
                                            %>
                                    ...
                                    <div class="nav-item-has-dropdown">
                                        ...
                                        <div class="nav-dropdown">
                                            <% List<Category> listSummer
                                                        = (List<Category>) request.getAttribute("summer");
                                                if (listSummer != null) {
                                                    for (Category c
                                                            : listSummer) {
                                            %>
                                    ...
                                    <div class="nav-item-has-dropdown">
                                        ...
                                        <div class="nav-dropdown">
                                            <% List<Category> listPant
                                                        = (List<Category>) request.getAttribute("pant");
                                                if (listPant != null) {
                                                    for (Category c
                                                            : listPant) {
                                            %>
                                    ...
                                    <div class="nav-item-has-dropdown">
                                        ...
                                        <div class="nav-dropdown">
                                            <% List<Category> listAcc
                                                        = (List<Category>) request.getAttribute("accessories");
                                                if (listAcc != null) {
                                                    for (Category c
                                                            : listAcc) {
                                            %>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions mt-4">
                                <form action="add-to-cart"
                                    ...
                                    <div
                                        class="action-buttons d-flex mt-3">
                                        <button type="submit"
                            ...
                            <div
                                class="product-share mt-3 text-center">
                                <span class="mr-2"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        ...
                        <p style="font-size: 14px; margin-bottom: 5px;">
                            ...
                            Quận Bắc Từ Liêm, Tp. Hà Nộ
                        </p>
                        <p style="font-size: 14px; margin-bottom: 5px;">
                            <b>Mã Số
                                Doanh Nghiệp: </b>01D-8004624
                        </p>
                        <p style="font-size: 14px; margin-bottom: 5px;">
