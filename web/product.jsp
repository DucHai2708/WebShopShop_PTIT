                    ...
                    <%@page import="java.text.NumberFormat" %>
                        <%@page import="java.util.Locale" %>
                            <% Product product=(Product) request.getAttribute("product"); if (product==null) {
                                response.sendRedirect("home"); return; } NumberFormat
                                nf=NumberFormat.getNumberInstance(new Locale("vi", "VN" )); String
                                formattedPrice=nf.format((long) product.getPrice()); List<ProductVariant> variants =
                                product.getVariants();
                                ...
                                java.util.Set<String> colors = new java.util.LinkedHashSet<>();
                                        java.util.Set<String> sizes = new java.util.LinkedHashSet<>();
                                                ...
                                                if (v.getSize() != null && !v.getSize().isEmpty())
                                                sizes.add(v.getSize());
                                                }
                                                }
                                                %>
                                                ...
                                                <body>
                                                                    ...
                                                                    <div class="col-xl-7">
                                                                        <div class="nav-wrap">
                                                                            <div class="header-nav">
                                                                                <a href="home" class="header-item">Trang
                                                                                    chủ</a>
                                                                                <div class="nav-item-has-dropdown">
                                                                                    <a href="category?id=1"
                                                                                        class="header-item">Áo Thu
                                                                                        Đông</a>
                                                                                    <div class="nav-dropdown">
                                                                                        <% List<Category> listWinter =
                                                                                            (List<Category>)
                                                                                                request.getAttribute("winter");
                                                                                                if (listWinter != null)
                                                                                                {
                                                                                                for (Category c :
                                                                                                listWinter) {
                                                                                ...
                                                                                <div class="nav-item-has-dropdown">
                                                                                    <a href="category?id=2"
                                                                                        class="header-item">Áo xuân
                                                                                        hè</a>
                                                                                    <div class="nav-dropdown">
                                                                                        <% List<Category> listSummer =
                                                                                            (List<Category>)
                                                                                                request.getAttribute("summer");
                                                                                                if (listSummer != null)
                                                                                                {
                                                                                                for (Category c :
                                                                                                listSummer) {
                                                                                ...
                                                                                <div class="nav-item-has-dropdown">
                                                                                    ...
                                                                                    <div class="nav-dropdown">
                                                                                        <% List<Category> listPant =
                                                                                            (List<Category>)
                                                                                                request.getAttribute("pant");
                                                                                                if (listPant != null) {
                                                                                                for (Category c :
                                                                                                listPant) {
                                                                                                %>
                                                                                ...
                                                                                <div class="nav-item-has-dropdown">
                                                                                    ...
                                                                                    <div class="nav-dropdown">
                                                                                        <% List<Category> listAcc =
                                                                                            (List<Category>)
                                                                                                request.getAttribute("accessories");
                                                                                                if (listAcc != null) {
                                                                                                for (Category c :
                                                                                                listAcc) {
                                                                                                %>
                                                        ...
                                                        <div class="container-fluid">
                                                            <nav aria-label="breadcrumb">
                                                                <ol class="breadcrumb custom-breadcrumb">
                                                                    <li class="breadcrumb-item"><a href="home">Trang
                                                                            chủ</a>
                                                                    </li>
                                                    ...
                                                    <div class="product-detail-section mt-5 mb-5">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div
                                                                    class="col-xl-1 col-lg-2 col-md-2 d-none d-md-block">
                                                                ...
                                                                <div class="col-xl-5 col-lg-5 col-md-12">
                                                                    <div class="product-info">
                                                                        ...
                                                                        <p class="product-status">Tình trạng:
                                                                            <span>
                                                                                <%= product.getQuantity()> 0 ? "Còn hàng" : "Hết hàng" %>
                                                                            </span>
                                                                        </p>

                                                                        <%-- Thông báo lỗi tồn kho khi thêm vào giỏ --%>
                                                                        <% String cartErr = (String) session.getAttribute("cartError");
                                                                           if (cartErr != null) { %>
                                                                            <div class="alert alert-danger py-2 px-3" style="font-size:13px; border-radius:6px;">
                                                                                        ...
                                                                                        <% boolean firstColor=true; %>
                                                                                            <% for (String color :
                                                                                                ...
                                                                                                <div class="color-item <%= firstColor ? "active" : "" %>"
                                                                                                    data-color="<%= color.trim().toUpperCase() %>"
                                                                                                ...
                                                                                                <% boolean
                                                                                                    ...
                                                                                                    <% for (String size
                                                                                                        ...
                                                                                                        <div class="size-item <%= firstSize ? "active" : "" %>"
                                                                                                            data-size="<%= size.trim().toUpperCase() %>"
                                                                                                            style="cursor:pointer;">
                                                                        ...
                                                                        <div class="product-actions mt-4">
                                                                            <form action="add-to-cart" method="POST"
                                                                                ...
                                                                                <input type="hidden" name="variantId"
                                                                                    id="variantIdInput"
                                                                                    value="<%= (variants != null && !variants.isEmpty()) ? variants.get(0).getId() : 0 %>">
                                                                                ...
                                                                                <div class="action-buttons d-flex mt-3">
                                                                                    <button type="submit"
                                                                                        class="btn-add-cart w-50 mr-2">THÊM
                                                                                        VÀO GIỎ HÀNG</button>
                                                                                    <button type="button"
                                                                                        class="btn-buy-now w-50 ml-2"
                                                                                        onclick="buyNow()">MUA
                                                                                        NGAY</button>
                                                                                </div>
                                                                            </form>
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <p class="customer-desc">Tất cả các ngày trong tuần
                                                                    </p>
                                                                </div>
                                                                <div class="col-xl-3">
                                                                    <h3 class="customer-title">
                                                                    ...
                                                                    <p class="customer-desc">Các ngày trong tuần (trừ
                                                                        ngày
                                                                        lễ)</p>
                                                                </div>
                                                                <div class="col-xl-3">
                                                                    <h3 class="customer-title">Đăng ký nhận thông tin
                                                                        mới
                                                                    </h3>
                                                                    <div class="form-wrap">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <ul class="footer-item-list">
                                                                        ...
                                                                        <li class="footer-item">
                                                                            290 Nguyễn Trãi, Trung Văn (Gần Đại học Hà
                                                                            Nội)
                                                                        </li>
                                                                        <li class="footer-item">
                                                                    ...
                                                                    <h4 class="footer-list-title">Các tỉnh & thành phố
                                                                        khác:
                                                                    </h4>
                                                                    <ul class="footer-item-list">
                                                                        <li class="footer-item">
                                                                        ...
                                                                        <li class="footer-item">
                                                                            TP. Việt Trì: 2145 Đại Lộ Hùng Vương, Phú
                                                                            Thọ
                                                                        </li>
                                                                        <li class="footer-item">
                                                    ...
                                                    <script>
                                                        ...
                                                        $(document).ready(function () {
                                                            ...
                                                            <% if (variants != null) {
                                                                ...
                                                                {
                                                                    id: <%= v.getId() %>,
                                                                    color: '<%= v.getColor() != null ? v.getColor().trim().toUpperCase() : "" %>',
                                                                    size: '<%= v.getSize() != null ? v.getSize().trim().toUpperCase() : "" %>'
                                                                },
                                                            <%  }
                                                               } %>
                                                        ];
