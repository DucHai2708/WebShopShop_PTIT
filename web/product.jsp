...
<head>
    ...
    <title>Atino</title>
    <!-- CSS -->
    <link rel="stylesheet" href="./assets/csages/style.css">
    <link rel="stylesheet" href="./assets/csages/base.css">
    <link rel="stylesheet" href="./assets/csages/reset.css">
    <link rel="stylesheet" href="./assets/csages/product.css">
                    ...
                    <div class="col-xl-7">
                        <div class="nav-wrap">
                            <div class="header-nav">
                                <a href="#" class="header-item">Trang chủ</a>
                                <div class="nav-item-has-dropdown">
                                    <a href="#" class="header-item">Áo thun/Áo nỉ</a>
                                    <div class="nav-dropdown">
                                        <a href="#">Áo Nỉ / Áo Thun Dài Tay</a>
                                        <a href="#">Áo Len</a>
                                        <a href="#">Áo Khoác</a>
                                        <a href="#">Cardigan</a>
                                        <a href="#">Áo Blazer / Áo Măng Tô</a>
                                        <a href="#">Áo Hoodie</a>
                                        <a href="#">Bộ thể thao thu đông</a>
                                    </div>
                                </div>
                                <div class="nav-item-has-dropdown">
                                    <a href="#" class="header-item">Áo xuân hè</a>
                                    <div class="nav-dropdown">
                                        <a href="#">Áo Nỉ / Áo Thun Dài Tay</a>
                                        <a href="#">Áo Len</a>
                                        <a href="#">Áo Khoác</a>
                                ...
                                <div class="nav-item-has-dropdown">
                                    <a href="#" class="header-item">Quần</a>
                                    <div class="nav-dropdown">
                                        <a href="#">Áo Nỉ / Áo Thun Dài Tay</a>
                                        <a href="#">Áo Len</a>
                                        <a href="#">Áo Khoác</a>
                                ...
                                <div class="nav-item-has-dropdown">
                                    <a href="#" class="header-item">Phụ kiện</a>
                                    <div class="nav-dropdown">
                                        <a href="#">Áo Nỉ / Áo Thun Dài Tay</a>
                                        <a href="#">Áo Len</a>
                                        <a href="#">Áo Khoác</a>
    ...
    <div class="breadcrumb-section">
        <div class="container-fluid"> <nav aria-label="breadcrumb">
                <ol class="breadcrumb custom-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Áo nỉ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Áo Nỉ Fitted L.2.7812</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-1 col-lg-2 col-md-2 d-none d-md-block">
                    <div class="product-thumbnails">
                        <img src="./assets/images/product1.jpeg" alt="" class="thumb-img active">
                        <img src="./assets/images/product2.jpeg" alt="" class="thumb-img">
                        <img src="./assets/images/product1.jpeg" alt="" class="thumb-img">
                        <img src="./assets/images/product2.jpeg" alt="" class="thumb-img">
                        <img src="./assets/images/product1.jpeg" alt="" class="thumb-img">
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-5 col-md-10">
                    <div class="product-main-image">
                        <img src="./assets/images/product1.jpeg" alt="" id="main-product-img">
                        <div class="img-nav prev"><i class="fa-solid fa-chevron-left"></i></div>
                        <div class="img-nav next"><i class="fa-solid fa-chevron-right"></i></div>
                    </div>
                    <p class="zoom-text mt-3 text-center"><i class="fa-solid fa-magnifying-glass"></i> Click xem hình lớn hơn</p>
                </div>
    
                <div class="col-xl-5 col-lg-5 col-md-12">
                    <div class="product-info">
                        <h1 class="product-name">Áo Nỉ Fitted L.2.7812</h1>
                        ...
                        <div class="product-options">
                            <div class="option-group">
                                ...
                                <div class="color-list">
                                    <div class="color-item active"><img src="./assets/images/product1.jpeg" alt=""></div>
                                    <div class="color-item"><img src="./assets/images/product1.jpeg" alt=""></div>
                                </div>
                            </div>
                        ...
                        <div class="product-actions mt-4">
                            ...
                            <div class="action-buttons d-flex mt-3">
                                <button class="btn-add-cart w-50 mr-2">THÊM VÀO GIỎ HÀNG</button>
                                <button class="btn-buy-now w-50 ml-2">MUA NGAY</button>
                            </div>
                            
                            <button class="btn-wishlist w-100 mt-3"><i class="fa-regular fa-heart"></i> YÊU THÍCH</button>
                        </div>
    
                        <div class="product-share mt-3 text-center">
                            <span class="mr-2" style="font-size: 12px; color: #999;">CHIA SẺ</span>
                            <a href="#" class="share-icon"><i class="fa-brands fa-facebook-f"></i></a>
                        </div>
    
                        <div class="store-availability mt-4">
                            <div class="store-header">Cửa hàng còn sản phẩm này</div>
                            ...
                            <div class="store-list mt-2">
                                <div class="store-item">
                                    ...
                                    <div class="store-info">
                                        <p class="store-address">110 Phố Nhổn, HN, MB_CH1:</p>
                                        <p class="store-phone">0969326783</p>
                                        <p class="store-status in-stock">110 Phố Nhổn, HN, MB_CH1 <span>(Còn hàng)</span></p>
                                    </div>
                                </div>
                                <div class="store-item">
                                    <i class="fa-solid fa-location-dot"></i>
                                    <div class="store-info">
                                        <p class="store-address">208 Bạch Mai, HN, MB_CH4:</p>
                                        <p class="store-phone">0969824182</p>
                                        <p class="store-status out-stock">208 Bạch Mai, HN, MB_CH4 <span>(Hết hàng)</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
